...
{
	class AnimalBase;
	class SFW_Flesh_Base: AnimalBase
	{
		scope = 0;
		hiddenSelectionsMaterials[] = {"StalkerFWConfig\mutants\flesh\data\flesh.rvmat"};
		model = "StalkerFWConfig\mutants\flesh\flesh.p3d";
		displayName = "Flesh";
		descriptionShort = "";
		...
		class AnimEvents
		{
			...
			class Sounds
			{
				class WolfBark
				{
					soundSet = "SFW_Mutants_flesh_aggressive_soundset";
					noise = "WolfRoarNoise";
					id = 1;
				};
				class WolfBark_1
				...
				class WolfBreath
				{
					soundSet = "SFW_Mutants_flesh_idle_soundset";
					noise = "WolfRoarNoise";
					id = 4;
				};
				class WolfGroans
				{
					soundSet = "SFW_Mutants_flesh_pain_soundset";
					noise = "WolfRoarNoise";
					id = 5;
				};
				class WolfGrowl_A
				...
				class WolfPant
				{
					soundSet = "SFW_Mutants_flesh_panic_soundset";
					noise = "WolfRoarNoise";
					id = 9;
				};
				class WolfPantShort
				...
				class WolfDeath
				{
					soundSet = "SFW_Mutants_flesh_death_soundset";
					noise = "WolfRoarNoise";
					id = 20;
				};
			};
