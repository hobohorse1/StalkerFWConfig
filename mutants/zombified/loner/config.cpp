class CfgPatches
{
	class SFW_Mutant_Zombified_Loner
	{
		units[] = {"SFW_Mutant_Zombified_Loner"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class SFW_Mutant_Zombified_Loner: ZombieMaleBase
	{
		...
		scope = 2;
		hiddenSelections[] = {""};
		model = "StalkerFWConfig\mutants\zombified\loner\lonerzombie.p3d";
