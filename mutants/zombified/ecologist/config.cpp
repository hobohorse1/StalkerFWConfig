...
class CfgPatches
{
	class SFW_Mutant_Zombified_Eco
	{
		units[] = {"SFW_Mutant_Zombified_EcoOrange","SFW_Mutant_Zombified_EcoGreen"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class SFW_Mutant_Zombified_EcoOrange: ZombieMaleBase
	{
		scope = 2;
		hiddenSelections[] = {"mutant"};
		hiddenSelectionsTextures[] = {"StalkerFWConfig\mutants\zombified\ecologist\data\eco_orange.paa"};
		model = "StalkerFWConfig\mutants\zombified\ecologist\ecologistzombie.p3d";
		displayName = " Ecologist Zombie";
		descriptionShort = "";
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 200;
					healthLevels[] = {{1,{"StalkerFWConfig\mutants\izlom\data\izlom.rvmat"}},{0.7,{"StalkerFWConfig\mutants\izlom\data\izlom.rvmat"}},{0.5,{"StalkerFWConfig\mutants\izlom\data\damage.rvmat"}},{0.3,{"StalkerFWConfig\mutants\izlom\data\damage2.rvmat"}},{0,{"StalkerFWConfig\mutants\izlom\data\damage3.rvmat"}}};
				};
			};
			class DamageZones
			{
	...
	class SFW_Mutant_Zombified_EcoGreen: SFW_Mutant_Zombified_EcoOrange
	{
		hiddenSelections[] = {"mutant"};
		hiddenSelectionsTextures[] = {"StalkerFWConfig\mutants\zombified\ecologist\data\eco_green.paa"};
		hiddenSelectionsMaterials[] = {"StalkerFWConfig\mutants\zombified\ecologist\data\eco_green.rvmat"};
	};
};
