...
{
	class AnimalBase;
	class SFW_Boar: AnimalBase
	{
		simulation = "dayzanimal";
		scope = 2;
		model = "StalkerFWConfig\mutants\boar\boar.p3d";
		displayName = "Boar";
		descriptionShort = "";
		DamageSphereAmmos[] = {"MeleeWolf"};
		aiAgentTemplate = "Predators_Wolf";
		hiddenSelectionsTextures[] = {"StalkerFWConfig\mutants\boar\data\boar.paa"};
		hiddenSelectionsMaterials[] = {"StalkerFWConfig\mutants\boar\data\boar.rvmat"};
		...
		class DamageSystem
		{
			...
			class DamageZones
			{
				class Zone_Head
				{
					...
					fatalInjuryCoef = 0.0156;
					canBleed = 0;
					class Health
					{
						hitpoints = 120;
						transferToGlobalCoef = 0.54;
					};
					class Blood: Health
					{
						hitpoints = 0;
		...
		class AnimEvents
		{
			...
			class Sounds
			{
				class WolfBark
				{
					soundSet = "SFW_Boar_Bark_Soundset";
					noise = "WolfRoarNoise";
					id = 1;
				};
				class WolfBark_1
				...
				class WolfBreath
				{
					soundSet = "SFW_Boar_Breath_Soundset";
					noise = "WolfRoarNoise";
					id = 4;
				};
				class WolfGroans
				{
					soundSet = "SFW_Boar_Groan_Soundset";
					noise = "WolfRoarNoise";
					id = 5;
				};
				class WolfGrowl_A
				{
					soundSet = "SFW_Boar_Growl_Soundset";
					noise = "WolfRoarNoise";
					id = 6;
				};
				class WolfGrowl_B
				...
				class WolfPant
				{
					soundSet = "SFW_Boar_Pant_Soundset";
					noise = "WolfRoarNoise";
					id = 9;
				};
				class WolfPantShort
				...
				class WolfSnarl
				{
					soundSet = "SFW_Boar_Snarl_Soundset";
					noise = "WolfRoarNoise";
					id = 11;
				};
				...
				class WolfWhimper
				{
					soundSet = "SFW_Boar_Whimper_Soundset";
					noise = "WolfRoarNoise";
					id = 13;
				};
				class WolfYelp
				{
					soundSet = "SFW_Boar_Yelp_Soundset";
					noise = "WolfRoarNoise";
					id = 14;
				};
				class WolfYawn
				{
					soundSet = "SFW_Boar_Yawn_Soundset";
					noise = "WolfRoarNoise";
					id = 15;
				};
				class WolfDeath
				{
					soundSet = "SFW_Boar_Death_Soundset";
					noise = "WolfRoarNoise";
					id = 20;
				};
			};
